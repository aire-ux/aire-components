...
public class InternationalizationBeanPostProcessor implements BeanPostProcessor, FieldFilter {

  private final ApplicationContext context;
  private final ResourceBundleResolver resourceBundleResolver;

  public InternationalizationBeanPostProcessor(
      @NonNull ResourceBundleResolver resolver, @NonNull ApplicationContext context) {
        ...
        field -> {
          ...
          if (fieldValue instanceof HasText) {
            ...
            throw new IllegalArgumentException(
                String.format(
                    "Error: cannot set field %s of type %s on class %s to value %s of type %s",
                    field, field.getType(), type, fieldValue, field.getType()));
          }
        },
        this);
  }
  ...
  private void doLocalize(
      HasText field, Localized annotation, ResourceBundle resourceBundle, String bundleName) {
  ...
  public boolean matches(Field field) {
    return field.isAnnotationPresent(Localized.class) && field.trySetAccessible();
  }
}
