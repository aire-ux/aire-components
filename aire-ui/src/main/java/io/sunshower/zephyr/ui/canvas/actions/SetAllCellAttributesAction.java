...
public class SetAllCellAttributesAction extends
    AbstractClientMethodBoundAction<List<CellAttributes>> {
  ...
  public ClientResult<List<CellAttributes>> apply(Model model) {
    ...
    return ClientResult.createList(CellAttributes.class,
        method.invoke(model.getHost(), attributes));
  }
}
