...
import com.aire.ux.control.canvas.Constants.Modules;
...
@Tag("aire-canvas")
@JavaScript("@aire-ux/aire-designer-component/dist/src/index.js")
...
@NpmPackage(
    value = Modules.AIRE_UX_DESIGNER_COMPONENT,
    version = Versions.AIRE_UX_DESIGNER_COMPONENT)
