...
public interface TestContext {
  ...
  /**
   *
   * @param types the collection of types to select.  If this list is
   *              empty or null, return <i>all</i> matching types
   ...
   */
  @Nonnull
  List<?> selectElements(Class<?>...types);
   ...
   */
  <T extends Component> T selectFirst(Class<T> type);
